...
**Phase 3 preview result (2026-05-21, N=4 first-life alpha cells, EXPLORATORY):** Lead time of disagreement-onset over capacity-knee-point = mean +19.5 cyc (sd 13.5), 3 of 4 cells positive. **Below the 50-cycle pre-reg falsification floor.** Direction supports C2 but magnitude is small. W8 (most stable cell) shows zero lead over knee-point and -23 cyc lead over knee-onset — single-operator curvature can match the cross-operator framework on stable cells. C2's added value may live more in Phase 4 mode-classification than Phase 3 lead-time on this dataset. See [literature/11_phase3_preview_leadtime.md](literature/11_phase3_preview_leadtime.md).
