...
| CLM-095 | **Consensus-day rain alignment reveals 2 cleaning regimes:** weather-driven (K=1-11, alignment rises with K to 25% at K=8, lift 1.65×) + operational/manual (K=12-13, alignment CRASHES to 5-10% << baseline 15%, ~42 site-wide events over 12yr ~3.5/yr) — substrate-novel methodology separates natural from operational cleaning | **VERIFIED-OWN / NOVEL-FRONTIER (HARDENED)** | Probe 5d memo 29 §6d | Tool for any multi-system single-site soiling analytics; explains why per-system rain-alignment (5b) was only 1.3× lift. **V2 verification 2026-05-30:** HARDENED via journal + conference sweep — candidate primary publishable methodological artifact. **Watch-item:** retrieve IEEE 11132652 (Meyers/Dufour/Ogut PVSC-53 2025) full text to confirm no embedded cleaning-classification subsection; if present, downgrade to PARTIAL |
