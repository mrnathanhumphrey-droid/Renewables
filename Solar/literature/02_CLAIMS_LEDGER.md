...
| CLM-093 | **Wet-season soiling DEPOSITION rate is HIGHER than dry-season at Alice Springs** (median 0.173 vs 0.128 %/day; 11/13 systems, Mann-Whitney one-sided p=0.9996 OPPOSITE direction; dry/wet ratio 0.74×) — naive "dry=more soiling" prediction is wrong; consistent with "muddy soiling" + summer dust-storms | **VERIFIED-OWN** | Probe 5c memo 29 §6c | Substrate-novel; operational implication: post-wet-season cleaning may capture bulk of annual losses |
| CLM-094 | Inter-system soiling-recovery synchrony at DKA is 4.78× over random (78 pairs, Jaccard median 0.259 vs baseline 0.054) — all pairs above random; site shares cleaning events | **VERIFIED-OWN** | Probe 5d memo 29 §6d | Same-site design enables this test (impossible on PVDAQ) |
| CLM-095 | **Consensus-day rain alignment reveals 2 cleaning regimes:** weather-driven (K=1-11, alignment rises with K to 25% at K=8, lift 1.65×) + operational/manual (K=12-13, alignment CRASHES to 5-10% << baseline 15%, ~42 site-wide events over 12yr ~3.5/yr) — substrate-novel methodology separates natural from operational cleaning | **VERIFIED-OWN** | Probe 5d memo 29 §6d | Tool for any multi-system single-site soiling analytics; explains why per-system rain-alignment (5b) was only 1.3× lift |
