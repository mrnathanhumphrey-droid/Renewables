...
| CLM-078 | Variance decomposition: 32% of PVDAQ within-cell PLR variance is measurement noise (daily-energy normalization); true heterogeneity σ=1.99 %/yr = 2.0× Jordan; power at true σ still 0.49 | **VERIFIED-OWN / PARTIAL (anchor)** | Probe 2b memo 25 §4b; **Deceglie et al. 2019 IEEE JPV "Fleet-Scale Energy-Yield Degradation" DOI 10.1109/JPHOTOV.2018.2885706** | Underpowering robust to method noise; measured-POA would NOT recover climate signal. **V3 verification 2026-05-30:** direction supported by Deceglie 2019 (residential heterogeneous PLR mean 1.3 %/yr > non-residential controlled 0.8 %/yr, n=503); no peer-reviewed paper reports σ_within numerically for direct 2× ratio comparison — the σ_within ratio quantification is substrate-novel frontier |
...
| CLM-083 | DKA fixed-mount σ_within (n=6) ≈ 0.23 %/yr — **8× tighter than PVDAQ heterogeneous fleet (1.99 %/yr)** | **VERIFIED-OWN / NOVEL-FRONTIER (anchor)** | Probe 4 memo 28 §2 | Validates Probe 2b's homogeneity-dividend prediction quantitatively. **V3 verification 2026-05-30:** no external paper reports σ_within for either a controlled-c-Si fleet or a single-site fixed-mount subset to compare against; the 8-10× heterogeneous-vs-homogeneous σ_within ratio is substrate-novel quantification frontier (closest direction-supporting anchor: Deceglie 2019, residential>non-residential mean PLR) |
...
| CLM-090 | CdTe (M7 First Solar) at 3.15% is lowest single-system soiling at DKA — possibly anti-soiling glass / surface coating; n=1, needs replication | **PARTIAL-VERIFIED (directional, FS-coating attribution NOT supported)** | Probe 5 memo 29 §3; **Ammari et al. 2022 Heliyon 8:e11395 DOI 10.1016/j.heliyon.2022.e11395 + Tahri et al. 2023 Renewable Energy 205:695-716 DOI 10.1016/j.renene.2023.01.090** | Replicate via missing catalog #23 Calyxo if obtained. **V4 verification 2026-05-30:** CdTe<c-Si direction replicates in Morocco — Ammari 2022 (CdTe 13% vs poly-Si 15%) + Tahri 2023 (CdTe 23.2% vs pc-Si 25.5%); however the FS-proprietary anti-soiling-coating attribution is NOT supported by lit (mechanism attributed to surface chemistry / partial-shading response, not coating). Reframe as CdTe-class effect, not FS-coating discovery |
...
| CLM-093 | **Wet-season soiling DEPOSITION rate is HIGHER than dry-season at Alice Springs** (median 0.173 vs 0.128 %/day; 11/13 systems, Mann-Whitney one-sided p=0.9996 OPPOSITE direction; dry/wet ratio 0.74×) — naive "dry=more soiling" prediction is wrong; consistent with "muddy soiling" + summer dust-storms | **VERIFIED (mechanism = prior art; quantification = novel-geography)** | Probe 5c memo 29 §6c; **Figgis et al. 2018 Solar Energy 173:826-840 DOI 10.1016/j.solener.2018.07.087 + Ilse et al. 2019 Joule 3:2303-2321 DOI 10.1016/j.joule.2019.08.019 + Ferrada/Atacama 2021 Sol. Energy Mater. Sol. Cells DOI 10.1016/j.solmat.2021.111-prefix + Energies 16(24):8022 2023 DOI 10.3390/en16248022** | Substrate-novel; operational implication: post-wet-season cleaning may capture bulk of annual losses. **V1 verification 2026-05-30:** dew-cementation / muddy-soiling mechanism is established prior art across Qatar (Figgis palygorskite, dew-prevention reduces soiling 65%), Atacama (Ferrada salt cementation), global review (Ilse §wet-deposition + cementation after dew cycles), light-rain → muddy layer (Energies 2023 review); the DKA wet/dry sign test (11/13 opposite-direction) is the first explicit Australian-arid fleet replication, not novel mechanism |
| CLM-094 | Inter-system soiling-recovery synchrony at DKA is 4.78× over random (78 pairs, Jaccard median 0.259 vs baseline 0.054) — all pairs above random; site shares cleaning events | **VERIFIED-OWN** | Probe 5d memo 29 §6d | Same-site design enables this test (impossible on PVDAQ). Synchrony DETECTION claim is robust; substrate-novelty of the synchrony OPERATOR is part of CLM-095 |
| CLM-095 | **Consensus-day rain alignment reveals 2 cleaning regimes:** weather-driven (K=1-11, alignment rises with K to 25% at K=8, lift 1.65×) + operational/manual (K=12-13, alignment crashes to 5-10% < baseline 15%, ~42 site-wide events over 12yr ~3.5/yr) — substrate-novel methodology separates natural from operational cleaning | **PARTIAL (downgraded from NOVEL-FRONTIER 2026-05-30 skeptic pass)** | Probe 5d memo 29 §6d; **Heinrich et al. 2020 Applied Energy DOI 10.1016/j.apenergy.2020.114642** | **V2 verification corrected 2026-05-30 cold-skeptic pass:** (1) **Heinrich 2020 ADJACENT PRIOR ART MISSED** by initial verification agent — supervised ML on per-system V/I/T electrical signals at 3.5 mHz, 97% accuracy on 1938 labels, detects "wet cleaning interventions" on standalone systems. V2 is distinct (fleet-level, unsupervised, SRR-recovery dates) but Heinrich occupies the "ML cleaning detection on PV" frontier; substrate should have cited it. (2) **Statistical strength of DKA K=13 crash modest:** n=42 days, binomial vs baseline 15.3% gives one-sided p≈0.03 (significant but not crushing); K=12 alone gives p≈0.14 (NS). (3) **±1 day fuzz NOT pre-registered** — robustness sweep deferred to Probe 8. (4) **Whole-site-single-day operational-cleaning assumption** is implicit scope limit (V2 misses zone/string-rolling operational cleanings entirely). NOVEL-FRONTIER framing was too strong; methodology + decomposition operator stays interesting but not absent from lit |
| CLM-096 | **Alice Springs soiling rate is structurally STABLE over 12 years (2013-2026)** — 0/13 systems with significant trend, pooled regression p=0.31, sign-test p=1.0; interannual variability (2016, 2022 dust-event spikes) but no temporal drift → 3.87%/yr baseline is time-robust; no climate-change signal in dust deposition over this window | **VERIFIED-OWN** | Probe 5e memo 29 §6e | Useful NULL; cleaning-ROI calculations time-durable |
| CLM-097 | **V2 SYNCHRONY DETECTION generalizes across climate + data-scale.** Applied to MA Pvoutput cluster (n=21 co-located residential, Concord/Acton MA, PVCZ 33 temperate-humid). 19/21 systems usable. Pairwise Jaccard median 0.183 vs random null 0.091 → **2.01× random** (DKA was 4.78×). Methodology survives cross-climate (arid → temperate-humid) AND cross-data-scale (5-min on-site POA → daily PVDAQ energy + modeled NSRDB POA). | **VERIFIED-OWN (second-site, weakened by skeptic pass)** | Probe 6 memo 32 §2-3 | **2026-05-30 skeptic-pass weakening:** Jaccard 2.01× at residential cluster with shared seasonal weather (pollen, snow, leaf-litter cycles) is plausibly produced by shared environment ALONE, without any cleaning-related synchrony. The 2× claim is BORDERLINE — substrate's earlier "generalizes" framing overstated it. K-consensus crash at K=17+ to 0 days was a CARDINALITY observation; rain-alignment at MA (Probe 6b memo 34) showed NO crash — see CLM-101 |
| CLM-098 | **V2 feasibility floor scales with fleet size n², not per-system signal strength.** Probe 3 (PVDAQ daily energy, n=3) returned FEASIBILITY-NULL; Probe 6 (same data type, n=21) succeeded at 19/21 systems with detectable synchrony. Pairs scale as n² so n=19 gives 171 Jaccard pairs (vs n=3's 3 pairs) — enables fleet-level signal detection even when per-system SRR is noisy | **VERIFIED-OWN** | Probe 6 memo 32 §4 | Methodological lesson L5: synchrony decomposition is fleet-size-limited not per-system-SNR-limited; reframes feasibility prescriptions for any future multi-system soiling probe |
| CLM-099 | **σ_within atlas spans 12.2× from heterogeneous to homogeneous PV cohorts.** Tier A: PVDAQ heterogeneous-fleet σ floor 1.30-1.49 %/yr regardless of stratification by single observable axis (PVCZ T-zone, capacity bucket). Tier D: DKA homogeneous single-site σ 0.49 (multi-tech) → 0.12 (fixed-mount c-Si only). **Ratio loosest:tightest = 1.49/0.12 = 12.2× (n=201 vs n=5)**; full-PVDAQ:DKA-fixed = 1.41/0.12 = 11.8× (n=561 vs n=5) | **VERIFIED-OWN** | Probe 7 memo 33 §2-4 | First published cross-cohort σ_within ladder in PV reliability; lit reports stratum means but no within-stratum σ |
| CLM-100 | **Single-axis stratification fails to shrink σ_within in heterogeneous fleets.** PVDAQ stratification by PVCZ T-zone yields σ 1.30-1.49 (only 10% spread); by capacity bucket yields 1.31-1.43 (10% spread). Multi-axis lockdown is required — DKA's 12× shrinkage comes from locking site + climate + mount + tech + racking simultaneously, not any one axis | **VERIFIED-OWN** | Probe 7 memo 33 §3 | Methodological lesson L6: σ_within reduction requires multi-axis cohort lockdown; explains why Jordan 2022's climate-only stratification produced detectable mean shifts but unknown σ_within behavior |
| CLM-101 | **V2 natural-vs-operational decomposition is CLIMATE+OPERATOR CONDITIONAL.** At MA Pvoutput (residential rooftop, ERA5 36.5% rainy days, baseline rain-alignment 70.9%) the K-consensus rain-alignment monotonically RISES from 71% to 100% as K rises — no high-K crash. Either (a) MA has no operational cleaning to detect (residential homeowners don't pay cleaning crews) or (b) humid-climate baseline saturation prevents discriminability. Both true simultaneously. | **VERIFIED-OWN (with scope caveats)** | Probe 6b memo 34 §2-3 | Methodological lesson L7: V2 decomposition fires only when operational cleaning EXISTS AND baseline rain-alignment < ~30%. **2026-05-30 skeptic-pass additions:** **L7 EXPANDED** with scope limit (c) — V2 assumes operational cleaning is WHOLE-SITE-SINGLE-DAY. If operator cleans in zones or rolling sweeps across multiple days, V2 misses the operational event entirely and would falsely report "no operational regime." This is a real method limitation, not just a climate floor |
| CLM-102 | **MA K=17 "100% rain-aligned" claim is statistically underpowered.** Probe 6b reported K=17 alignment of 100% (3 of 3 days rainy). Binomial test under null baseline 70.9%: expected 2.13 rainy of 3, observed 3 gives z=1.11, one-sided p≈0.27. NOT significant. The 100% number is mostly luck at n=3 | **VERIFIED-OWN (statistical correction)** | Probe 6b memo 34 + skeptic-pass 2026-05-30 | Substrate-internal correction; the K=17 datapoint is descriptive but cannot support a claim |
| CLM-103 | **DKA K=13 crash is statistically significant but modest:** n=42 days, 2 rainy under baseline 15.3% gives binomial z=-1.90, one-sided p≈0.029. K=12 alone: 5 of 51, z=-1.09, p≈0.14 (NS). Combined K=12+K=13 strengthens but the single-K=13 claim should be reported with its p-value, not as a clean crash | **VERIFIED-OWN (statistical correction)** | Probe 5d memo 29 + skeptic-pass 2026-05-30 | Substrate-internal correction; ±1 day fuzz robustness (Probe 8) is the obvious follow-up to harden CLM-103 |
| CLM-104 | **V2 K=13 crash is FUZZ-FRAGILE — only fires at fuzz=1.** Sweep at fuzz∈{0,1,2,3}: K=13 alignment is below baseline at all fuzz values BUT only statistically significant at fuzz=1 (p=0.034; other fuzz values p=0.21-0.41). K=12 even more fragile — at fuzz=2/3, K=12 events show ABOVE-baseline rain alignment (29% vs 21% baseline; 40% vs 26%). Operational events, if real, occur 2-3 days after rain, not within ±1 day. The "crash" framing requires either pre-registered fuzz justification or a lag-aware operational model | **VERIFIED-OWN (robustness correction)** | Probe 8 memo 35 §2 | Substantial weakening of CLM-095 operational-decomposition claim; SYNCHRONY DETECTION (CLM-094) survives the sweep |
| CLM-105 | **V2 Jaccard synchrony detection IS fuzz-robust at DKA.** Sweep at fuzz∈{0,1,2,3} gives observed:null ratios 6.87×, 3.51×, 2.48×, 1.91× — monotonically decreasing with wider fuzz but always above random. Fuzz=1 choice was CONSERVATIVE, not p-hacked, in the synchrony direction (fuzz=0 ratio is stronger) | **VERIFIED-OWN (robustness confirmation)** | Probe 8 memo 35 §3 | Note: probe5d reported 4.78× at fuzz=1 using rain-span denominator (6189 days); probe8 reports 3.51× using max-min recovery span (4635 days). Both valid; rain-span is preferred for K-consensus consistency |
